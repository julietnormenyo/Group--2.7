...
- **2 New Safety Checks**:
 1. **Resistor Validity**: `Valid | Design accepted` if R > 0
 2. **LED Current Check**: `Unsafe!` if current > 30mA
...
LED Forward Voltage : 22.00 V
Desired LED Current : 21.00 mA
---------------------------------------------------
Calculated Resistor : 2761.90 Ohms
Min Power Dissipated: 1.22 W
Recommended Power : 3.00 W resistor
---------------------------------------------------
Validity : Valid | Design accepted
LED Current Status : Safe
Overall Safety : REQUIRING REVIEW
===================================================
...
Aryitey Aaron (01246383B) - Testing lead
Juliet Normenyo (01244425B) - GitHub manager
Oppong duah Immanuel  -	Documentation lead
Naa Larley Lartey Perida (01245581B) -	Presentation lead
